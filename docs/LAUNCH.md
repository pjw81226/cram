...
- [ ] **Create the GitHub repo** and push. Replace every `cram-cli/cram` placeholder with your real `owner/repo`:
  - `README.md` (badges, clone URL, comparison links)
  - `src/core/formatter.ts` (the "Generated by cram" banner URL)
